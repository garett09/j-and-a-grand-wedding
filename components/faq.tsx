    ...
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-[#f5f4f0]">
      ...
      <div className="relative z-10 w-full px-6 sm:px-8 md:px-16">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 max-w-6xl mx-auto">
          {/* Left - Questions */}
          <div className="w-full lg:w-2/3 space-y-8 md:space-y-10 order-2 lg:order-1">
            {faqs.map((faq, index) => (
          ...
          {/* Right - Title */}
          <div className="w-full lg:w-1/3 flex items-start justify-center lg:justify-end order-1 lg:order-2">
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-wide text-[#1a1a1a] leading-[1.1] text-center lg:text-right">
